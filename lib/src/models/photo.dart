...
class Photo {
  ...
  factory Photo.fromMap(Map<String, dynamic> map) {
    return Photo(
        ...
        promotedAt: map['promoted_at'] != null ? map['promoted_at'] as String : null,
        width: map['width'] ?? 1,
        height: map['height'] ?? 1,
        color: map['color'],
        ...
        altDescription: map['alt_description'] != null ? map['alt_description'] as String : null,
        ...
        currentUserCollections: map["current_user_collections"] != null
            ? (map["current_user_collections"] as List).map((collection) => collection["id"].toString()).toList()
            : [],
        sponsorship: map['sponsorship'] != null ? Sponsorship.fromMap(map['sponsorship']) : null,
        topicSubmissions: map['topic_submissions'],
        user: User.fromMap(map['user'] as Map<String, dynamic>),
        tags: map["tags"] != null ? (map["tags"] as List).map((tag) => Tag.fromMap(tag)).toList() : []);
  }
